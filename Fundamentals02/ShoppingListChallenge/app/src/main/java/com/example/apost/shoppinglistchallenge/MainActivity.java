package com.example.apost.shoppinglistchallenge;
...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView List1, List2, List3, List4, List5, List6, List7, List8, List9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storeName = findViewById(R.id.edit_store);
    }
